...
```mermaid
graph TD
    subgraph The Employee Lifecycle
        A[1. Attraction & Recruitment] --> B[2. Development & Performance Management];
        B --> C[3. Motivation & Retention];
        C --> D[4. Exit];
    end
    D -.->|Feedback Loop: <br> Reputation & Alumni Network| A;
```
